    ...
    hotels: [
      {
        ...
        description:
          "A 5-star luxury hotel with panoramic city views, rooftop pool, and award-winning restaurant.",
        amenities: [
          "Free WiFi",
          "Rooftop Pool",
          "Spa & Sauna",
        ...
        reviews: [
          {
            name: "Alex",
            rating: 5,
            text: "Amazing stay! The rooftop pool was incredible.",
            date: "2025-07-10",
          },
          {
            name: "Sarah",
          ...
          },
          {
            name: "John",
            rating: 5,
            text: "Best hotel in Paris. Will come back!",
            date: "2025-05-15",
          },
        ],
        policies: {
      ...
      },
      {
        ...
        description:
          "Charming boutique hotel in the heart of artistic Montmartre. Cozy rooms with vintage decor.",
        amenities: [
          "Free WiFi",
          "Breakfast Included",
          "Terrace",
        ...
        reviews: [
          {
            name: "Emma",
            rating: 5,
            text: "Felt like home! Beautiful decor and cozy atmosphere.",
            date: "2025-06-11",
          },
          {
            name: "Leo",
            rating: 4,
            text: "Lovely view and close to local cafés.",
            date: "2025-05-03",
          },
        ],
        policies: {
        ...
        reviews: [
          {
            name: "Alice",
            rating: 5,
            text: "Delicious food and amazing ambiance!",
          },
          {
            name: "Michael",
            rating: 4,
            text: "Great service and tasty meals.",
          },
        ],
    ...
    sites: [
      {
        ...
        name: "Eiffel Tower",
        description:
          "An iconic Paris landmark offering breathtaking views of the city. A must-visit for first-time travelers and photography lovers.",
        images: [
        ...
        reviews: [
          {
            name: "Liam",
            rating: 5,
            text: "Incredible views at sunset!",
            date: "2025-06-10",
          },
          {
            name: "Sophia",
            rating: 4,
            text: "Long queues but worth it.",
            date: "2025-06-18",
          },
        ],
      ...
      },
      {
        ...
        name: "Louvre Museum",
        description:
          "Home to thousands of works of art including the Mona Lisa. A paradise for art lovers and historians.",
        images: [
        ...
        reviews: [
          {
            name: "Emma",
            rating: 5,
            text: "Amazing collection of art!",
            date: "2025-07-01",
          },
          {
            name: "Noah",
            rating: 4,
            text: "Huge museum, plan at least 3-4 hours.",
            date: "2025-06-22",
          },
        ],
    ...
    hotels: [
      {
        ...
        description:
          "Ultra-modern skyscraper hotel with panoramic views of Tokyo skyline and Mount Fuji.",
        amenities: [
          "Free WiFi",
          "Sky Lounge",
          "Onsen Bath",
        ...
        reviews: [
          {
            name: "Haruto",
            rating: 5,
            text: "Spectacular view of the city! The onsen was a dream.",
            date: "2025-07-01",
          },
          {
            name: "Mia",
            rating: 4,
            text: "Very comfortable and clean. Great breakfast options.",
            date: "2025-06-18",
          },
        ],
        policies: {
    ...
    sites: [
      {
        ...
        name: "Tokyo Skytree",
        description:
          "Tallest tower in Japan offering panoramic views of Tokyo. Observation decks provide stunning day and night views.",
        images: [
        ...
        reviews: [
          {
            name: "Haruto",
            rating: 5,
            text: "Amazing skyline view!",
            date: "2025-07-01",
          },
          {
            name: "Mia",
            rating: 4,
            text: "Great but very busy on weekends.",
            date: "2025-06-18",
          },
        ],
      ...
      },
      {
        ...
        description:
          "Tokyo’s oldest temple and a major cultural landmark. Famous for its giant lantern and traditional shopping street.",
        images: [
        ...
        reviews: [
          {
            name: "Yuki",
            rating: 5,
            text: "Beautiful traditional temple.",
            date: "2025-05-20",
          },
          {
            name: "Ken",
            rating: 4,
            text: "Crowded but worth visiting.",
            date: "2025-05-22",
          },
        ],
    ...
    hotels: [
      {
        ...
        description:
          "Private villas with infinity pools overlooking the Indian Ocean. Perfect for romance and relaxation.",
        amenities: [
          "Private Pool",
          "Beach Access",
          "Spa",
        ...
        reviews: [
          {
            name: "Liam",
            rating: 5,
            text: "Absolutely paradise! The private pool villa was stunning.",
            date: "2025-06-10",
          },
          {
            name: "Sophia",
            rating: 4,
            text: "Peaceful retreat. Loved the ocean view.",
            date: "2025-05-20",
          },
        ],
        policies: {
    ...
    sites: [
      {
        ...
        description:
          "A picturesque sea temple perched on a rock. Famous for stunning sunsets and cultural significance.",
        images: [
        ...
        reviews: [
          {
            name: "Liam",
            rating: 5,
            text: "Magical sunset spot!",
            date: "2025-06-10",
          },
          {
            name: "Sophia",
            rating: 4,
            text: "Crowded but beautiful.",
            date: "2025-05-20",
          },
        ],
      ...
      },
      {
        ...
        description:
          "Lush green rice terraces in Ubud offering peaceful walks and amazing photos. Perfect for nature lovers.",
        images: [
        ...
        reviews: [
          {
            name: "Aiden",
            rating: 5,
            text: "Absolutely serene and beautiful.",
            date: "2025-06-15",
          },
          {
            name: "Olivia",
            rating: 4,
            text: "Amazing scenery, very relaxing.",
            date: "2025-05-25",
          },
        ],
