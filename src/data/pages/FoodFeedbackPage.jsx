// src/pages/FoodFeedbackPage.jsx
...
export default function FoodFeedbackPage() {
  ...
  const [speedOfService, setSpeedOfService] = useState(0);
  ...
  for (const dest of destinations) {
    restaurant = dest.restaurants?.find(r => r.id === restaurantId);
    if (restaurant) break;
  }
  ...
  const restaurantImage = 
    ...
    (Array.isArray(restaurant.image) && restaurant.image[0]) ||
  ...
  const handleSubmit = (e) => {
    ...
    const existing = JSON.parse(localStorage.getItem('foodFeedbacks') || '[]');
    existing.push(newFeedback);
    localStorage.setItem('foodFeedbacks', JSON.stringify(existing));
    ...
    <div className="min-vh-100 bg-light">
      ...
      <div className="position-relative overflow-hidden" style={{ height: '60vh' }}>
        ...
        <div className="position-absolute top-50 start-50 translate-middle text-center text-white px-4">
          <h1 className="display-3 fw-bold text-shadow">{restaurant.name}</h1>
          <p className="lead fs-4 text-shadow">How was your dining experience?</p>
        </div>
        <Button
          variant="light"
      ...
      <Container className="py-5">
        {showSuccess && (
          <Alert variant="success" className="text-center mb-5">
            Thank you! Your detailed food feedback has been saved.
          </Alert>
        )}
        ...
        <Form onSubmit={handleSubmit} className="bg-white p-5 rounded-4 shadow-lg">
          ...
          <BigStarRating 
            ...
            label="How would you rate the taste and presentation of your food?" 
          />
          <hr className="my-5" />
          ...
          <BigStarRating 
            rating={portionSize} 
            setRating={setPortionSize} 
            label="Were the portion sizes adequate?" 
          />
          <hr className="my-5" />
          ...
          <BigStarRating 
            ...
            label="Was the staff polite, attentive, and timely?" 
          />
          <hr className="my-5" />
          ...
          <BigStarRating 
            ...
            label="Was the dining area and washroom clean?" 
          />
          {cleanliness > 0 && (
          ...
          <BigStarRating 
            rating={ambience} 
            setRating={setAmbience} 
            label="How was the atmosphere and comfort of the restaurant?" 
          />
          <hr className="my-5" />
          ...
          <BigStarRating 
            ...
            label="Was the pricing fair for the quality and service?" 
          />
          <hr className="my-5" />

          {/* Speed of Service */}
          <BigStarRating 
            rating={speedOfService} 
            setRating={setSpeedOfService} 
            label="Was your food served promptly?" 
          />
          <hr className="my-5" />
          ...
          <BigStarRating 
            rating={menuVariety} 
            setRating={setMenuVariety} 
            label="Did you find enough choices on the menu?" 
          />
          <hr className="my-5" />
          ...
          <div className="mb-5">
            ...
            <small className="text-muted">Show your favorite dish or the vibe!</small>
          </div>
          ...
          <div className="mb-5">
            ...
            <small className="text-muted">Max 30 sec clip of your meal</small>
          </div>
          ...
          <div className="mb-5">
            ...
            <Form.Control
              as="textarea"
              rows={5}
              placeholder="Must-try dish? Best time to visit? Any tips?"
              value={feedback}
          ...
          <p className="text-center mt-4 text-muted small">
            Your detailed review helps foodies discover the best spots.
          </p>
        </Form>
      </Container>
    </div>
